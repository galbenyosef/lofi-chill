...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      // oxlint-disable-next-line jsx-a11y/prefer-tag-over-role -- Groups one control with its addons, not a set of form fields.
      role="group"
      className={cn(
...
function InputGroupAddon({
  ...
  return (
    // oxlint-disable-next-line jsx-a11y/click-events-have-key-events, jsx-a11y/no-noninteractive-element-interactions -- Click only extends the input focus target; the input already supports keyboard focus.
    <div
      // oxlint-disable-next-line jsx-a11y/prefer-tag-over-role -- Groups one control with its addons, not a set of form fields.
      role="group"
